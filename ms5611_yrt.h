...
typedef enum{
YRT_OK, // 0, her şey yolunda
YRT_ERROR, //1, sensör ya da i2c bağlantı hatası
...
YRT_STATUS_t MS5611_Init( MS5611_t *sensor_data);

YRT_STATUS_t MS5611_ReadRawData(MS5611_t *sensor_data);
